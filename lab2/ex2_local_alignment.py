...
#                                                                              #
# This program performs the local alignment of two strings of text using the   #
# Smith-Waterman algorithm. Example:                                           #
# ./ex2_local_alignment.py AATCG AACG 1 -1 -2                                  #
...
def main():
    ...
    for i in range(1, h):
        for j in range(1, w):
            ...
            if D[i, j] > D[max_i, max_j]:
                max_i = i
                max_j = j

    score = D[max_i, max_j]
    print("Local alignment score: %0.1f" % score)
    print(D)
