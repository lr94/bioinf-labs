...
from lab9.classifier import RecurrentClassifier
...
def main():
    ...
    classifier = RecurrentClassifier(learning_rate=0.005, epochs=2, bidirectional=True)
    print("Training classifier (%s recurrent network)" %
          ("bidirectional" if classifier.bidirectional else "monodirectional"))
